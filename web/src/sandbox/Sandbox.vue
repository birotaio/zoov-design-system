    ...
    .sandbox
          ...
          .sandbox__flex
            ...
            template(v-for="name in ['light', 'dark'].concat(colorList)")
              .ma-0
                ...
                .px-2.py-1(
                  :class="name === 'light' ? 'neutral--light-4' : name === 'dark' ? 'neutral--dark-4' : name"
                )
                  template(v-for="z in elevations")
                    z-card.my-3.px-3.py-1(
                      :class="'elevation-' + z + '--' + name"
                    )
      ...
      .sandbox__content
        ...
        .sandbox__section
          ...
          .sandbox__flex
            z-checkbox(
              label="<p>Label with <b>HTML CONTENT</b></p>"
              html
            )
          .sandbox__flex
            z-checkbox(
          ...
          .sandbox__flex
            z-checkbox(
              label="Indeterminate"
              :indeterminate.sync="checkboxIndeterminate1"
            )
          .sandbox__flex
            z-checkbox(
              label="Disabled"
          ...
          .sandbox__flex
            z-checkbox(
              ...
              :indeterminate="checkboxIndeterminate2"
              disabled
            )
          h6 Colors
          .sandbox__flex
      ...
      .sandbox__content
        ...
        .sandbox__section.sandbox__component--layout
          ...
          .sandbox__flex
            z-layout
              template(
                v-for="name in [...colorList, 'primary--dark-1', 'success--dark-1', 'info--dark-1']"
              )
                z-col(
                  lg1
                  md2
